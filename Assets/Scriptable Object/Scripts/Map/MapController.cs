...
public class MapController : MonoBehaviour
{
    ...
    public float optimizerCooldowmDur;
    ...
    void SpawnChunk()
    {
        ...
        latestChunks = Instantiate(terrainChunks[rand], noTerrainPosition, Quaternion.identity);
    ...
    void ChunkOptimizer()
    {
        ...
        {
            optimizerCooldown = optimizerCooldowmDur;
        } else
        {
            return;
        }
